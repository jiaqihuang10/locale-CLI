            ...
            if (this.props.selectedFiles.includes(asset.__typename)) {
                if (this.state.eachFileDone[asset.__typename]) {
                    ...
                    if (asset.__typename === "TenantTheme") {
                        return h(DownloadEachFile, { name: asset.__typename, dir: this.dir, data: JSON.stringify(asset.variables), handleDownloadDone: this.handleDownloadDone });
                    } else {
                        return h(DownloadEachFile, { name: asset.__typename, dir: this.dir, data: JSON.stringify(asset.values), handleDownloadDone: this.handleDownloadDone });
                    }
                }
            }
        });
