        ...
        const downloadList =  this.props.data.map(asset => {
            if (this.props.selectedFiles.includes(asset.__typename)) {
                if (asset.__typename === "TenantTheme") {
                   return (<DownloadEachFile name={asset.__typename} dir={dir} data={JSON.stringify(asset.variables)} />);
                } else {
                   return (<DownloadEachFile name={asset.__typename} dir={dir} data={JSON.stringify(asset.value)} />);
                } 
            }
        });
        return (
